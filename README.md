...
├─ support/ # Custom commands & global hooks  # Cypress Automation Portfolio
...
### 🛒 **cart/**  
Full cart functionality tests: add single/multiple products, remove products, badge verification, cart count, multi-product scenarios using Page Object Model.
